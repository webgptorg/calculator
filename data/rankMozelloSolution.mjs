...
export function rankMozelloSolution(preferences) {
    ...
    if (productsCount > 0) {
        solutionRank.note(
            'Mozello poskytuje pohodlné řešení pro malé a střední eshopy s podporou až 500 produktů.',
        );
    }
    ...
    if (levelOfControl > 0.7) {
        solutionRank.bigCon('Mozello nemusí být ideální volbou pro klienty vyžadující vysokou úroveň kontrolu nad designem.');
    } else {
